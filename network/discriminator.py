...
class SimpleDiscriminator(nn.Module):
    def __init__(self, size=4, in_cha=3, inplace=True):
        ...
        self.conv_model = nn.Sequential(
            nn.Conv2d(in_cha, 16, 5, 2, 2, bias=True),
        ...
        self.regressor =nn.Linear(128 * size * size, 1)# 映射【0，1】实数域  vit_base的 vit_base_gan0.005
